...
const Q_PRODUCT_MATURITY: Tier2Question = {
  ...
  type: "single",
  options: [
    { id: "early", label: "Early stage / startup", sub: "Under 3 years or pre-Series B. Founder interviews, launch posts." },
...
const Q_UX_EXPERIENCE: Tier2Question = {
  ...
  options: [
    ...
    { id: "briefly", label: "Used it briefly (surface impressions)", sub: "Agent weights your context with external research" },
...
const Q_BIZ_MODEL_ASPECTS: Tier2Question = {
  ...
  options: [
    ...
    { id: "revenue_streams", label: "Revenue streams & diversification", sub: "Primary revenue plus secondary (services, marketplace, data)" },
...
const Q_METRICS_TO_SURFACE: Tier2Question = {
  ...
  options: [
    ...
    { id: "revenue_arr", label: "Revenue / ARR / MRR estimates", sub: "Direct or estimated from pricing x customer count" },
    { id: "user_growth", label: "User growth rate (QoQ or YoY)", sub: "Signals about acceleration or deceleration" },
    { id: "app_store", label: "App store rating & review count", sub: "Rating trend over time and volume" },
...
const Q_STRATEGIC_FRAMEWORKS: Tier2Question = {
  ...
  options: [
    ...
    { id: "growth_loop", label: "Growth loop mapping", sub: "Input to output to reinvestment compounding engine" },
...
const Q_RECOMMENDATIONS: Tier2Question = {
  ...
  options: [
    ...
    { id: "both", label: "Both: analysis with a separate recommendations section", sub: "Agent splits into two distinct sections" },
  ],
};

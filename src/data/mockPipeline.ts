    ...
    slides: [
      ...
      },
      {
        ...
        phases: [
          ...
          { label: "Enterprise Sales", desc: "Champion-led deals with SSO and admin controls", metric: "ACV ↑" },
        ],
      },
      {
        type: "techstack",
